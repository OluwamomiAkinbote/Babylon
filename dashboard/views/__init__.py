from .admin_blog import blog_table, create_post, edit_blogpost, delete_blogpost
from .admin_user import user_login, reset_password_view, user_logout
...
from .admin_videos import video_table, create_video, edit_video, delete_video